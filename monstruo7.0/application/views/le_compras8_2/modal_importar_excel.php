<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">Subir Archivo Excel - Compras 8.2</h4>
        </div>
        <div class="modal-body">

            <img height="280px" id="img_producto" class="card-img-top">
            <form id="frmSubirImagen" method="post" action="<?php echo base_url()?>index.php/le_compras8_2_detalles/guardar_file_excel" enctype="multipart/form-data" >
...
$(document).ready(function(){
    ...
    frm.bind('submit', function(e){
        ...
        ruta_url_item = base_url + 'index.php/le_compras8_2_detalles/importarExcel/' + $("#mes").val() + '/' + $("#anio").val();
