...
<html>
    ...
    <body>
        ...
        <div style="padding-top: 10px;">
            ...
            <div id="numero">
                <div align="right">
                    <table align="right">
                    <tr>
                        <td style="background-color: #54BDA1">Número:</td>
                        <td style="background-color: #54BDA1; font-size: 20px"><?php echo $cabecera['serie']."-".$cabecera['numero']."<br>"?></td>
                    </tr>
                    <tr>
        ...
        <table style="width: 100%" border="1" cellspacing="0" cellpadding="0" class="detalle">
            <thead>
                <tr style="background-color: #54BDA1">
                    <th>CANT.</th>
                    <th>U.M.</th>
                    <th>COD.</th>
                    <th>DESCRIPCIÓN</th>
        ...
        <table class="totales" style="width: 100%">            
            ...
            <tr>
                ...
                <td style="background-color: #54BDA1">Total</td>
                <td style="background-color: #54BDA1"><?php echo $cabecera['simbolo_moneda']?></td>
                <td style="background-color: #54BDA1" class="derecha_text"><?php echo number_format($cabecera['total_a_pagar'] - $anticipo_total_pagar, 2)?></td>
            </tr>
            <?php }?>
        </table>
