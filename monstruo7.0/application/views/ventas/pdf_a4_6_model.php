...
<html>
    ...
    <body>
        ...
        <div id="div_header">
            ...
            <div id="logo">
                <div align="right">
                    <img aling="right" src="<?PHP FCPATH;?>images/empresas/<?php echo $empresa['foto'];?>" class="responsive" style="text-align:center;" ><br>
                </div>                
            </div>    
        </div>
        ...
        <div style="padding-top: 10px;">
            ...
            <div id="numero">
                <div align="right">
                    <table align="right">
                    <tr>
                        <td style="background-color: #4e01b2; color: white"><b>Número:</b></td>
                        <td style="background-color: #4e01b2; font-size: 20px; color: white"><b><?php echo $cabecera['serie']."-".$cabecera['numero']."<br>"?></b></td>
                    </tr>
                    <tr>
        ...
        <table style="width: 100%" border="1" cellspacing="0" cellpadding="0" class="detalle">
            <thead>
                <tr style="background-color: #4e01b2; color: white">
                    <th>CANT.</th>
                    <th>U.M.</th>
                    <th>COD.</th>
                    <th>DESCRIPCIÓN</th>
        ...
        <table class="totales" style="width: 100%">            
            ...
            <tr>
                ...
                <td style="background-color: #4e01b2; color: white"><b>Total</b></td>
                <td style="background-color: #4e01b2; color: white"><b><?php echo $cabecera['simbolo_moneda']?></b></td>
                <td style="background-color: #4e01b2; color: white" class="derecha_text"><b><?php echo number_format($cabecera['total_a_pagar'] - $anticipo_total_pagar, 2)?></b></td>
            </tr>
            <?php }?>
        </table>
