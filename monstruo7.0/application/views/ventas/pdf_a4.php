            ...
            <tr>
                <td style="width: 70%">
                    <table>
                        <tr>
                            <td>        
                                <img src="<?PHP FCPATH;?>images/empresas/<?php echo $empresa['foto'];?>" class="responsive" style="text-align:center;" ><br>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <div class="tabla_borde">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="letra_mediana"><?php echo $cabecera['direccion_cliente_de_venta']?></td>
                            </tr>
                            <?php                            
                            if($cotizacion != array()){?>
                            <tr>
                    ...
                    <div class="tabla_borde">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="letra_mediana"><?php echo ucfirst($cabecera['moneda'])?></td>
                            </tr>
                            <?php
