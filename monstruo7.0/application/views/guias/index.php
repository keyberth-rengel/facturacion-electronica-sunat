...
<h2 align="center">Guias Remitente</h2>
<br>
<div class="container">
    <div class="row">
        <div class="col-md-2">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        //Enviar Mail
        $('#tabla_guia_id').on('click', '.btn-mail', function(){
            console.log('aaaa');
            var venta_id = $(this).attr('id');
            let venta_guia = 2; //1 ventas, 2 guia_remision, 3 guia_transportista
    ...
    function carga_inicial(){
        ...
        $.getJSON(url_l)
            .done(function (data) {
                ...
                var numero_orden = 1;
                (data.guias).forEach(function (repo) {
                    agregarFila(numero_orden, repo.guia_id, repo.entidad, repo.fecha_emision, repo.fecha_traslado, repo.serie, repo.numero, repo.venta_numero, repo.destinatario_id, repo.estado_operacion);
                    numero_orden ++;
                });                                                
        });
    }    
    ...
    var nepele;
    function agregarFila(numero_orden, guia_id, entidad, fecha_emision, fecha_traslado, serie, numero, venta_numero, destinatario_id, estado_operacion){
        ...
        fila += '<td align="center"><a id="'+destinatario_id+'" class="btn btn-default btn-xs btn_ubicacion" data-toggle="modal" data-target="#myModal">'+entidad+'</a></td>';
