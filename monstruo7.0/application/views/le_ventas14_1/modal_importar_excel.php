<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">Subir Archivo Excel - Ventas 14.1</h4>
        </div>
        <div class="modal-body">

            <img height="280px" id="img_producto" class="card-img-top">
            <form id="frmSubirImagen" method="post" action="<?php echo base_url()?>index.php/le_ventas14_1_detalles/guardar_file_excel" enctype="multipart/form-data" >
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response != 0) {
                    ...
                    ruta_url_item = base_url + 'index.php/le_ventas14_1_detalles/importarExcel/' + $("#mes").val() + '/' + $("#anio").val();
