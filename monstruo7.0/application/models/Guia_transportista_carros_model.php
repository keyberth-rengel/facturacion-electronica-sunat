...
class Guia_transportista_carros_model extends CI_Model{

    public $tabla = 'guia_transportista_carros';
    ...
    public function delete_guia_id($guia_id){
        $sql = "DELETE FROM $this->tabla WHERE guia_transportista_id = " . $guia_id;
        $this->db->query($sql);
    }
}